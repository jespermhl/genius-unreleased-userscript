...
(function () {
    ...
    function headerHtml() {
        ...
        return '<span class="' + cls + '">YouTube Suggestions</span>';
    }
    ...
    function injectStyles() {
        ...
        style.textContent = [
            'div[class*="AudioAndMedia__Container"] > div[class*="MetadataRow"]:has(div[class*="AudioAndMedia__ImageFieldContainer"]){display:grid!important;grid-template-columns:minmax(0,1fr) minmax(0,1fr)!important;gap:0 24px;}',
            ...
            '.' + LIST_CLASS + '{max-height:100px;overflow-y:auto;overscroll-behavior:contain;scrollbar-width:thin;}',
